...
unit=names(5)
       ...
       if not rs.eof then
        ...
        response.Write "<script language=javascript>alert('该产品不用这种材料！');</script>"
        response.write "<meta http-equiv=""refresh"" content=""0;url=dindang1.asp"">"
         response.end
        end if
        end if
 ...
 if chuku="彩印" and fenlei="面膜" then
 set rs=server.createobject("adodb.recordset") 
 ...
 elseif chuku="复合" and fenlei="面膜" then
        set rs=server.createobject("adodb.recordset") 
        sql="select * from cailiao_out_store"
        rs.open sql,conn,1,3
        rs.addnew          
...
<b><font color="#ffffff">编辑调拨信息</font></b>
...
%>
    <table width="800" border="0" cellpadding="0" cellspacing="0" >
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">添加调拨信息</font></b>
...
<%end if %>
        <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#0055E6">
          <tr class="but"> 
			<td width="15%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">类 别</td>
...
<td height="18" align="center" class="but11" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but11'">
	<select name='chuku'  size="1" style='width:60; height:20'>
			...
			<option selected value='复合'>复合</option>
            <option selected value='彩印'>彩印</option>           
                 			<%else%>
			<option selected value='复合'>复合</option>
            <option selected value='彩印'>彩印</option>
			<%end if%>			
  ...
  <table width="800"  border="1" cellpadding="0" cellspacing="0" bordercolor="#0055E6" align="center">
    ...
    <tr> 
      ...
      <td width="800" align="center" valign="top">
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">&nbsp; 材 料 调 拨 列 表</font></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<% if oskey="chejian" then%><input type="button" name="close" value="关闭" onclick="window.close();" /><%end if%>
      ...
      <td width="100%" align="center" valign="top">
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
          <tr class="but"> 
			...
			<td width="26%" height="18" align="center" class="but01" onMouseDown="this.classname='tddown'" onMouseUp="this.classname='but'" onMouseOut="this.classname='but01'">品 名</td>
			...
			<td width="6%" height="18" align="center" class="but01" onMouseDown="this.classname='tddown'" onMouseUp="this.classname='but'" onMouseOut="this.classname='but01'">	现有量</td>
            <td width="13%" height="18" align="center" class="but01" onMouseDown="this.classname='tddown'" onMouseUp="this.classname='but'" onMouseOut="this.classname='but01'">说明</td>
...
%>&nbsp;&nbsp;&nbsp;&nbsp;<%if oskey="supper" or oskey="admin" then%>
     <input type="checkbox" name="checkbox" value="checkbox" onClick="javascript:SelectAll()"> 选择/反选
              <input type=submit value=隐藏 name=action> 
<%end if%></td></tr>
        </table>
