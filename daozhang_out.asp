...
<BODY topMargin=0 rightMargin=0 leftMargin=0>       
 ...
 <tr>
 <td colspan="3" align=center valign=middle height=107>
	<p style="line-height: 200%"><font size="3">安徽嘉美包装有限公司</font><b><font size="5"><br>
	<u>收&nbsp;&nbsp;&nbsp;&nbsp; 款&nbsp;&nbsp;&nbsp;&nbsp; 单</u></font></b></p></td>
</tr>
<tr>
...
<tr>
<td height="30" align=center width="15%"><font size="3"><b>到账时期</b></font></td>
<td height="30" align=center width="31%"><b><font size="3">客户</font></b></td>
<td height="30" align=center width="20%"><b><font size="3">数量</font></b></td>
<td height="30" align=center width="12%"><font size="3"><b>到账方式</b></font></td>
<td height="30" align=center width="12%"><font size="3"><b>到账银行</b></font></td>
<td height="30" align=center width="10%"><b><font size="3">类型</font></b></td>
</tr>
<% 
...
sql="select * from daozhang where id in ("&selBigClass&")"
rs.open sql,conn,1,1

  %>

<tr><td height="25" align=center><%=rs("uptime")%></td>
	<td height="25" align=center><%=rs("kehu")%></td>
    <td height="25" align=center><%=Formatnumber(rs("Loan_num"),2,-1,0,0)%>元</td>
    <td height="25" align=center ><%=rs("fanshi")%></td>
    <td height="25" align=center><%=rs("yinhang")%></td>
    <td height="25" align=center><%=rs("leixin")%></td>
</tr>
...
<tr>
<td height="30" align=left width="100%" colspan="6"  >
