...
<input name="kuang" type="text" style="ime-mode:disabled"  size="4" value='<% if isedit then
			...
			<td height="13" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'" width="252">
...
<%
		   ...
		   do while not rs.eof
			...
			<option ><%=rs("kehu")%> 『<%=rs("pinming")%>』 <%if isnull(rs("bian")) or rs("bian")="" then%> <%=rs("chang")%><%else%><%=rs("chang")+rs("bian")%><%end if%>*<%if isnull(rs("di")) or rs("di")="" then%><%=rs("kuang")%><%else%><%=rs("kuang")+rs("di")%><%end if%> 【<%=rs("nianbang")%>】&nbsp;&nbsp;&nbsp;&nbsp;<%=Formatnumber((rs("nianbang")*rs("cunshu")+rs("nianbang2")*rs("cunshu2")*1.05+rs("nianbang3")*rs("cunshu3")*1.05+rs("nianbang4")*rs("cunshu4"))*0.105,1,0)%> </option>
			<%
			rs.movenext
			loop
			end if
...
<br>
<TABLE width=1000 align=center border="0" cellspacing="20" cellpadding="2" bordercolor="#0055E6" height="164">
<tr>
<td >
  ...
  <table width="1000"  border="1" cellpadding="0" cellspacing="0" bordercolor="#0055E6" align="center">
    ...
    <tr> 
      ...
      <td width="1000" align="center" valign="top">
            ...
            <tr >  
            <td height=26 background="images/background.gif">
            <b><font color="#ffffff">产 品 库 存 列 表</font></b></td>
            </tr>
            </table>
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
          ...
          <tr class="but"> 
			<td width="7%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">出库日期</td>
            <td width="5%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">类 别</td>
			<td width="30%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">品 名</td>
			<td width="5%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">规格</td>
			<td width="7%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">数 量</td>
			<td width="7%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">应做<br>
			袋数</td>
			<td width="12%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" colspan="2">卷材（ 公斤）</td>
			<td width="12%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" colspan="2">成品袋（只）</td>
            <td width="6%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">差额<br>
			(只)</td>
            ...
            <td width="4%" height="36" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'" rowspan="2">操作</td>

          </tr>
          <tr class="but"> 
			<td width="6%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">千米重</td>
			<td width="6%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">实做</td>
			<td width="6%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">尚做</td>
			<td width="6%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">实做</td>
			</tr>
<%
...
rs.Source="select* from matur where cname like '%"&keyword&"%' order by -id"
else
rs.Source="select* from matur order by -id"
end if
...
<td height="18" align="center"><%=rs("chxp")%></td>
<td height="18" align="center"><%=rs("cname")%></td>
<td height="18"  align="center"><%=rs("chang")%>*<%=rs("kuang")%></td>
<td height="18" align="center"><%=Formatnumber(rs("number"),2,-1,0,0)%></td>
<td height="18" align="center"><%if rs("chang")="0" or rs("kuang")="0" then%>&nbsp;<%else%><%=Formatnumber(rs("number")*(rs("guige")-1.3)/rs("chang")/rs("kuang")/2*100000,0)%><%end if%></td>
<td height="18" align="center"><%if rs("zhesuang")="0" then%>&nbsp;<%else%><%=rs("zhesuang")%><%end if%></td>
<td height="18" align="center"><%if rs("mishu")="0" then%>&nbsp;<%else%><%=rs("mishu")%><%end if%></td>
...
<%end if%></td>
<td height="18" align="center"><%if rs("daishu")="0" then%>&nbsp;<%else%><%=rs("daishu")%><%end if%></td>
...
%>
<tr><td align="center" colspan="13" height="22">
