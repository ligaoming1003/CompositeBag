...
<table width="600" border="1" cellpadding="0" cellspacing="0" bgcolor="#ffffff"  bordercolor="#000000">
          <tr><td height="35" colspan="12" align="center">
			<font size="4" face="黑体"><b>出库成型品汇总明细</b></font></td></tr>
		  <tr> 
            <td width="10%" height="22" align="center" >出库日期</td>
            <td width="50%" align="center" >品 名</td>
            <td width="10%" align="center" >成品</td>
            <td width="10%" align="center" >半成品</td>
            <td width="10%" align="center" >员工</td>
...
%>
                   <tr><td colspan="3" height="30"> 符合查询条件的出库记录总共为 <font color="#cc0000"><%=i%></font> 条</td><td  align="right">总计：</td><td align="center"><%=numm%>&nbsp;</td><td align="center">
　</td></tr>
				</table>
				<table>
