...
id=rs("id")
 ...
 <td colspan="2" align=center valign=middle height=147>　<p>　</p>
	<p><u><font size="5"><b>订单档案</b></font></u></td>
</tr>
<tr>
...
<b>面膜</b>：<%if rs("name1")="0" or rs("name1")="" then %>&nbsp;<%else%><%=rs("name1")%>&nbsp;<%=rs("nianbang")%>*<%=rs("cunshu")%>&nbsp;&nbsp;版号：<%=rs("pihao")%><%end if%></font><p align="left">
<font size="3"><b>说明</b>：<%=rs("chati")%><br>
　</font></td>
...
<td height="40" align=center colspan="2">
<p align="left"><font size="3"><br>
<%if rs("name2")="0" or rs("name2")="" then %><%else%><b>中膜</b>：<%=rs("name2")%>&nbsp;<%=rs("nianbang2")%>*<%=rs("cunshu2")%>&nbsp;&nbsp;<%end if%>
<%if rs("name3")="0" or rs("name3")="" then %><%else%>&nbsp;</font><p align="left">
<font size="3"><b> 鸳膜</b>：<%=rs("name3")%>&nbsp;<%=rs("nianbang3")%>*<%=rs("cunshu3")%>&nbsp;&nbsp;<%end if%><b><br>
<br>
 内膜</b>：<%if rs("name4")="0" or rs("name4")="" then %>&nbsp;<%else%><%=rs("name4")%>&nbsp;<%=rs("nianbang4")%>*<%=rs("cunshu4")%><%end if%>&nbsp;&nbsp;<p align="left">
<b>说明</b>：<%=rs("chati4")%><br>
　</font></td>
...
<td height="80" align=center><b><font size="3">成品要求</font></b></td>
...
<td height="40" align=center><font size="3"><b>包装要求</b></font></td>
