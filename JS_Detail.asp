...
<table width="750" border="1" cellpadding="0" cellspacing="0" bgcolor="#ffffff"  bordercolor="#000000">
          <tr><td height="35" colspan="6" align="center">
			<font size="4" face="黑体"><b>客户结算明细</b></font></td></tr>
		  <tr> 
            <td width="10%" height="22" align="center" >日期</td>
            <td width="10%" align="center" >客户</td>
            <td width="31%" align="center" >名&nbsp;&nbsp;&nbsp; 称</td>
			<td width="12%" align="center" >客户付方</td>
            <td width="12%" align="center" >客户收方</td>
...
%>
                   <tr><td colspan="2" height="30"> 记录总共为 <font color="#cc0000"><%=i%></font> 条</td><td  align="right">总计：</td><td align="center"><%=Loan_Amount%></td><td align="center"><%=hkdz%></td><td align="center"><%if Loan_Amount-hkdz>0 then%>客户欠款：<%=Loan_Amount-hkdz%>元<%else%>客户长款：<%=hkdz-Loan_Amount%>元<%end if%></td></tr>
				</table>
				<table>
