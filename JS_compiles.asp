...
<tr>
  ...
  <td height="30" >
<input type="checkbox" name="SeachModel"   value=1>按客户</td>
...
<%=Loan_Amount%></font></td><td align="center" bgcolor="#FFFFFF"><%=hkdz%></td><td align="center" bgcolor="#FFFFFF"><%if Loan_Amount-hkdz>0 then%>客户欠款：<%=Loan_Amount-hkdz%>元<%else%>客户长款：<%=hkdz-Loan_Amount%>元<%end if%></td></tr>
