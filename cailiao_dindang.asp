...
sub SaveModify   
  ...
  response.write "<meta http-equiv=""refresh"" content=""0;url=cailiao_dindang.asp"">"
  response.end
else
...
<b><font color="#ffffff">库 存 材 料 列 表</font></b>
			...
			<form action="cailiao_dindang.asp" method="post" name="selform" >
...
<td height="18" align="center"><%=Formatnumber((rs("number")-rs("anpai")),2,-1,0,0)%></td>
...
共 <%=total%> 条，当前第 <%=Mypage%>/<%=Maxpages%> 
            ...
            <%
			if search<>"" then
			url="cailiao_dindang.asp?fenlei="&fenlei1&"&keyword="&keyword&"&search=search&"
			else
            url="cailiao_dindang.asp?"
			end if				
...
<b><font color="#ffffff">库存搜索</font></b>
        ...
        <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
		  ...
		  <form name="search" method="post" action="cailiao_dindang.asp">
