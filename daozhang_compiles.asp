...
<b><font color="#ffffff">货款到账信息查询</font></b>
...
<table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
  ...
  <td width="20%" height="30"><input type="checkbox" name=SeachModel value=1>按客户</td>
...
<td height="30" >
<input type="checkbox" name="SeachModel"   value=2>按到账方式</td>
<td><select name="fanshi"  style='width:130'>
			<option selected value="">请选择方式</option>
			<%			
...
<tr><td  height="30" ><input type="checkbox" name=SeachModel value=3>按到账日期</td>
<td ><INPUT  name="uptime" onFocus="show_cele_date(uptime,'','',uptime)" value="<%=year(now())%>-<%=month(now())%>-<%=day(now())%>"  size="8"> 到 <INPUT  name="uptime1" onFocus="show_cele_date(uptime1,'','',uptime1)" value="<%=year(now())%>-<%=month(now())%>-<%=day(now())%>"  size="8"></td>

<td  height="30" ><input type="checkbox" name="SeachModel"   value=4>按到账银行</td>
<td>
...
</tr><tr><td align="center" height="30" colspan="4"><input type="submit" name="Submit" value="查询" style="font-size: 9pt;  color: #000000; background-color: #EAEAF4; solid #EAEAF4" onMouseOver ="this.style.backgroundColor='#ffffff'" onMouseOut ="this.style.backgroundColor='#EAEAF4'" title="查询"></td></tr>
			</form>
	</table>
...
<td>
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">货款到账汇总查询</font></b>
...
<td>
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">年度到账汇总查询</font></b>
...
<table id = "PrintA" width="800" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
          <tr class="but"> 
                        <td width="10%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">日&nbsp;&nbsp; 期</td>
                        <td width="10%" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'"> 类&nbsp;&nbsp; 别</td>
                        <td width="20%" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">客&nbsp;&nbsp;&nbsp;&nbsp; 户</td>
                        <td width="15%" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">金&nbsp;&nbsp; 额</td>
			            <td width="10%" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">方&nbsp; 式</td>
			            <td width="20%" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">银&nbsp; 行</td>		
...
%>
                   <tr><td colspan="2" height="30" bgcolor="#FFFFFF">  记录总共为 <font color="#cc0000"><%=i%></font> 条</td>
