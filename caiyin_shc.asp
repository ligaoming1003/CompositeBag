...
sub delCate()
  ...
  response.write "<meta http-equiv=""refresh"" content=""0;url=caiyin_shc.asp"">"
  response.end
else
...
<b><font color="#800000">修改彩印车间出库信息</font></b><font color="#800000"> </font>
...
<%else%>
    <table width="800" border="0" cellpadding="0" cellspacing="0" >
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#800000">添加彩印车间出库信息</font></b><font color="#FFFF00"> </font>
...
<%end if %>
        <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#0055E6">
          <tr class="but"> 
			...
			<font color="#800000">&nbsp;&nbsp;&nbsp;&nbsp; 品 名 | 规&nbsp; 格 | 余数|&nbsp; 单位|&nbsp; 批号</font></td>
			...
			<font color="#800000">单位</font></td>
			
          </tr>
		  <form name="powersearch" method="post" action="caiyin_shc.asp" onSubmit="return Juge(this)" >
...
<select name="unit"  size="1" style='width:50; height:15'>
			<% if isedit then%><option ><%=rs("unit")%></option>
<%end if%>
		  ...
		  <tr class="but">
			...
			<font color="#800000">数&nbsp;&nbsp; 量</font></td>
			<td height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">
			<font color="#800000">换版
			</font>
			</td>
			...
			<p align="left"><font color="#800000">如果“领用车间”或“单位”有误，请先将数量修改为“0”，再重新出库。</font></td>
          </tr>
		  <tr> 
 <td height="18" align="center" class="but11" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but11'">
 ...
 <td height="18" align="center" class="but11" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but11'">
 <input name="bang" type="text" style="ime-mode:disabled"  size="6" value='<% if isedit then
		                                                         response.write rs("bang")
																  end if %>'></td>
  ...
  <table width="800"  border="1" cellpadding="0" cellspacing="0" bordercolor="#0055E6" align="center">
    ...
    <tr> 
      ...
      <td width="800" align="center" valign="top">
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font size="2" color="#800000">彩 印 出 库 列 表</font></b><font color="#800000"><font size="2">&nbsp;</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<b><input type="submit" name="button" id="button" onclick="window.location.href='cy.asp'" value="返回上一页" /></b></font></td>
</tr>
</table>
			<form action="caiyin_shc.asp" method="post" name="selform" >
...
共 <%=total%> 条，当前第 <%=Mypage%>/<%=Maxpages%> 
            ...
            <%
			if search<>"" then
			url="caiyin_shc.asp?keyword="&keyword&"&search=search&"
			else
            url="caiyin_shc.asp?"
			end if				
...
<td>
          ...
          <tr >  
<td height=26 background="images/background.gif">
<p align="center"><b><input type="submit" name="button" id="button" onclick="window.location.href='cy.asp'" value="返回上一页" /></b></td>
</tr>
</table>
