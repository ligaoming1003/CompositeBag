...
<b><font color="#ffffff">详细彩印出库信息查询</font></b>
...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr><td width="20%" height="30" ><input type="checkbox" name="SeachModel"   value=1>按员工</td><td>
...
<td height="30" ><input type="checkbox" name=SeachModel value=2>按出库日期
　</td>
...
<table width="800" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
          <tr class="but"> 
                        <td width="15%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">日期</td>
                        <td width="15%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">员 工</td>
                        ...
                        <td width="10%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">规 格</td>
                        ...
                        <td width="10%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">换 版</td>
...
<td height="18" align="center"><font color="#009900">千米</font></td>
