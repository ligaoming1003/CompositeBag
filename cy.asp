...
sub delCate()
  ...
  response.end
		...
		response.Write "<script language=javascript>alert('数量为0的，删除成功！\n\n数量不为0的没有被删除！');</script>"
        response.write "<meta http-equiv=""refresh"" content=""0;url=cy.asp"">"
        response.end
end if
  end sub
	   ...
	   set rs=server.createobject("adodb.recordset")
		   rs.open "select * from caiyin_in where id=" & request("id"),conn,1,1
                    ...
                    <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#0055E6">
                        <tr class="but">
                            <td width="40" height="18" align="center" class="but" onmousedown="this.className='tddown'" onmouseup="this.className='but'" onmouseout="this.className='but'">日期</td>
			...
			品 名 | 规&nbsp; 格 | 余数|&nbsp; 单位</td>
                            ...
                            <td width="80" height="18" align="center" class="but" onmousedown="this.className='tddown'" onmouseup="this.className='but'" onmouseout="this.className='but'">单位</td>
			...
			set rs1=nothing
                            ...
                            <tr class="but">
                                ...
                                <td height="36" align="center" class="but" onmousedown="this.className='tddown'" onmouseup="this.className='but'" onmouseout="this.className='but'" rowspan="2" width="315">
                                    <p align="justify">
                                        说明:1、出库数量请输入千米数，领用车间选择复合车间；<br>
                                        &nbsp;&nbsp;&nbsp;&nbsp; 2、无需复合的，请选择&quot;熟化室&quot;出库&nbsp;。 
			<br>
                                        &nbsp;&nbsp;&nbsp;&nbsp; 3、出库输入有误请在列表中点击品名，进行修改。</td>
                                <td height="18" align="center" class="but" onmousedown="this.className='tddown'" onmouseup="this.className='but'" onmouseout="this.className='but'" width="315">换版支数</td>
                                <td height="18" align="center" class="but" onmousedown="this.className='tddown'" onmouseup="this.className='but'" onmouseout="this.className='but'" width="80">员工</td>
                            </tr>
                            <tr>
                                <td height="18" align="center" class="but11" onmousedown="this.className='tddown'" onmouseup="this.className='but'" onmouseout="this.className='but11'" colspan="2">
                                    <input name="Loan_oan" type="text" style="ime-mode: disabled" size="9" value='0' onfocus="if(this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'"><font color="#FFFFFF">千米</font></td>
                    ...
                    <tr>
                        ...
                        <td width="800" align="center" valign="top">
                            <table width="800" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="26" background="images/background.gif">
                                        <b><font color="#ffffff">彩 印 出 库 列 表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>
                                            <input type="button" name="button" id="button" onclick="window.open('dindang1.asp')" value="查看材料" /></b></td>
                                </tr>
                            </table>
                                        ...
                                        <td width="100%" align="center" valign="top">
                                            ...
                                            <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
                                                <tr class="but">
                                                    ...
                                                    <td width="4%" height="18" align="center" class="but01" onmousedown="this.classname='tddown'" onmouseup="this.classname='but'" onmouseout="this.classname='but01'">换版</td>
                                                    ...
                                                    <td width="6%" height="18" align="center" class="but01" onmousedown="this.classname='tddown'" onmouseup="this.classname='but'" onmouseout="this.classname='but01'">员工</td>
                ...
                <table width="90%" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
                    ...
                    <form name="search" method="post" action="cy.asp">
                        <tr>
                            ...
                            <td align="center" width="84%">按姓名查找： 
