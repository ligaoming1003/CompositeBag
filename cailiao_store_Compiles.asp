...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
	<form name="powersearch" method="post" action="cailiao_store_Compiles.asp?action=search" >
...
<td width="20%" align="center" class="but1" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but1'">&nbsp;<a href="tiaozhen.Asp?id=<%=rs("ID")%>&action=edit"><font color="#000099"><%=rs("pinming")%></font></a></td>
...
%>
		...
		<br>
				<table cellpadding="0">
				<form name="search" method="post" action="cailiao_store_Detail.asp" target="_blank" >
				  <tr><td>
