...
rs3.update
response.Write "<script language=javascript>alert('结存应收款录入成功！');</script>"
...
rs3.update
response.Write "<script language=javascript>alert('结存应收款修改成功！');</script>"
response.write "<meta http-equiv=""refresh"" content=""0;url=zanfu.asp"">"
response.end
rs3.close
set rs3=nothing
...
<b><font color="#ffffff">编辑上年应收款结存</font></b>
...
%>
    <table width="800" border="0" cellpadding="0" cellspacing="0" >
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">添加上年应收款结存</font></b>
...
<td height="18" align="center" class="but11" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but11'"> 
			...
			<option selected value='上年结存'>上年结存</option>
  ...
  <table width="800"  border="1" cellpadding="0" cellspacing="0" bordercolor="#0055E6" align="center">
    ...
    <tr> 
      ...
      <td width="800" align="center" valign="top">
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">&nbsp;上 年 应 收 款 结 存 列 表</font></b>
...
<b><font color="#ffffff">销售搜索</font></b>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
		  ...
		  <tr><input name="search" type="hidden" value="search">
             <td align="center" width="36%">按客户名查找： 
