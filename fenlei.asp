...
<b><font color="#ffffff">编 辑 材 料 类 别</font></b>
...
%>
    <table width="600" border="0" cellpadding="0" cellspacing="0" >
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">添加 材 料 类 别</font></b>
...
<%end if %>
        <table width="600" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
          <tr class="but">
			<td width="200" height="18" align="center" class="but" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but'">类别编号</td>
            <td width="200" height="18" align="center" class="but" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but'">类别名称</td> 


			<td width="200" height="18" align="center" class="but" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but'" colspan="2">备注</td>
  ...
  <table width="600"  border="1" cellpadding="0" cellspacing="0" bordercolor="#0055E6" align="center">
    ...
    <tr> 
      ...
      <td width="600" align="center" valign="top">
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">材 料 类 别 列 表</font></b>
         ...
         <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
          <tr class="but"> 
			<td width="100" height="18" align="center" class="but01" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but01'">类别编号</td>
            <td width="200" height="18" align="center" class="but01" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but01'">类别名称</td>
			<td width="250" height="18" align="center" class="but01" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but01'">备 注</td>
            <td width="50" height="18" align="center" class="but01" onMouseDown="this.fenleiname='tddown'" onMouseUp="this.fenleiname='but'" onMouseOut="this.fenleiname='but01'">操 作</td>
          </tr>
		 <%
set rs=server.CreateObject("ADODB.RecordSet") 
