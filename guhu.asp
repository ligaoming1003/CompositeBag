...
rs2.update
response.Write "<script language=javascript>alert('过户款领取成功！');</script>"
response.write "<meta http-equiv=""refresh"" content=""0;url=guhu.asp"">"
response.end
rs2.close
set rs2=nothing
...
rs2("content")=content
rs2.update
response.Write "<script language=javascript>alert('过户款领取修改成功！');</script>"
response.write "<meta http-equiv=""refresh"" content=""0;url=guhu.asp"">"
response.end
rs2.close
set rs2=nothing
...
%>
    <table width="800" border="0" cellpadding="0" cellspacing="0" >
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">添加领用过户款</font></b></td>
</tr>
</table>
<%end if %>
        <table width="800" border="0" cellpadding="0" cellspacing="0" bordercolor="#0055E6">
          <tr class="but"> 
			...
			<td width="13%" height="18" align="center" class="but" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but'">客户名称</td>
		  ...
		  <form name="powersearch" method="post" action="guhu.asp" onSubmit="return Juge(this)" >
...
<td height="18" align="center" class="but11" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but11'"> 
			...
			<% if isedit then%>
		    <option selected value='其它领款'>其它领款</option>			
			<option selected value='过户领款'>过户领款</option>
...
<select name='use_dep' size="1" style='width:105; height:20'>
			<% if isedit then%>
...
<td height="18" align="center" class="but11" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but11'">
			...
			<select name='content' size="1" style='width:100; height:21'>
			<% if isedit then%>
				<option selected="selected"><%=rs("content")%></option>
...
<td >
			...
			<form action="guhu_out.asp" method="post" name="selform" >
  <table width="800"  border="1" cellpadding="0" cellspacing="0" bordercolor="#0055E6" align="center">
    ...
    <tr> 
      ...
      <td width="800" align="center" valign="top">
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">&nbsp;领 取 过 户 款 列 表</font></b>
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#EFEADD">
          <tr class="but"> 
			...
			<td width="30%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">
			款项类别</td>
			<td width="19%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">金额</td>
			<td width="14%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">客户名称</td>
			<td width="13%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">
			付款方式</td>
            <td width="4%" height="18" align="center" class="but01" onMouseDown="this.className='tddown'" onMouseUp="this.className='but'" onMouseOut="this.className='but01'">操 作</td>
          </tr>
		 <%
...
rs.Source="select* from JS_out_store where use_dep like '%"&keyword&"%' and pinming='过户领款'or pinming='其它领款' order by -id"
else
rs.Source="select* from JS_out_store where pinming='过户领款' or pinming='其它领款' order by -id"
end if
...
<td height="18" align="center"><a href="guhu.asp?id=<%=rs("ID")%>&action=edit"><%=rs("uptime")%></a></td>
<td height="18" align="center">&nbsp;<a href="guhu.asp?id=<%=rs("ID")%>&action=edit"><%=rs("pinming")%></a></td>
...
<td height="18" align="center"><%=rs("content")%><%if rs("content")="" or rs("content")="0" then%>&nbsp;<%end if%></td>
...
<p align="right">共 <%=total%> 条，当前第 <%=Mypage%>/<%=Maxpages%> 
            ...
            <%
			if search<>"" then
			url="guhu.asp?keyword="&keyword&"&search=search&"
			else
            url="guhu.asp?"
			end if				
...
<td>
          ...
          <tr >  
<td height=26 background="images/background.gif">
<b><font color="#ffffff">领款搜索</font></b>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#D4D0C8">
		  ...
		  <form name="search" method="post" action="guhu.asp">
