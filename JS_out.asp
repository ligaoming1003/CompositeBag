...
<tr>
<td height="30" align=center width="10%"><font size="3"><b>日期</b></font></td>
<td height="30" align=center width="26%"><font size="3"><b>客&nbsp; 户</b></font></td>
<td height="30" align=center width="12%"><font size="3"><b>金额</b></font></td>
<td height="30" align=center width="14%"><font size="3"><b>到账方式</b></font></td>
<td height="30" align=center width="16%"><font size="3"><b>到账银行</b></font></td>
<td height="30" align=center width="10%"><font size="3"><b>类型</b></font></td></tr>
<% 
...
response.end
elseif sum>20 then
response.write "<script language=javascript>alert('最多只能选二十项！');history.go(-1);</script>"
response.end
...
<td align=center><%=Formatnumber(rs("Loan_num"),2,-1,0,0)%>元</td>
